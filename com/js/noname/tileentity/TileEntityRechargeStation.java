package com.js.noname.tileentity;

import com.js.noname.block.BlockMachineRechargeStation;
...
public class TileEntityRechargeStation extends TileEntity implements ISidedInventory{
	...
	*/
	...
	{
    	return this.isInvNameLocalized() ? this.field_94130_e : "container.rechargeStation";
	}
	...
	public void updateEntity(){
    	...
    	if (!this.worldObj.isRemote){
        	...
        	{
            	flag1 = true;
            		BlockMachineRechargeStation.updateFurnaceBlockState(this.power > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
        		}	
    	}

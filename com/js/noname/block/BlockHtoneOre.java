...
public class BlockHtoneOre extends BlockOre {
	
	public BlockHtoneOre(int id) {
		super(id);
		
		this.setUnlocalizedName(Names.Blocks.OREHTONE);
	...
	public void registerIcons(IconRegister reg) {
		this.blockIcon = reg.registerIcon(Textures.Blocks.PATHOREHTONE);
	}
